...
export function AccordionTrigger({ children }: { children: React.ReactNode }) {
  return (
    <summary
      role="button"
      className="mt-2 flex w-full items-center justify-between gap-3 border-b border-purple-600 px-8 py-6 text-base font-bold leading-tight hover:underline group-open:bg-gray-100"
    >
      <div>{children}</div>
